...
const Sidebar = () => {
  return (
    <aside className="flex flex-col w-64 h-screen px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
      <p className="text-2xl font-semibold text-white">Nikash</p>
      ...
      <div className="flex flex-col justify-between flex-1 mt-6">
        ...
        <div>
          <div className="flex items-center justify-between">
            ...
            <button className="p-0.5 hover:bg-gray-100 duration-200 transition-colors text-gray-500 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-800 border rounded-lg"></button>
          </div>
